...
import { Button, Container, styled as MuiStyled, Theme, Typography } from '@mui/material'
...
const MainMessage = MuiStyled('div')((style: { theme: Theme }) => ({
  fontSize: 24,
  fontWeight: 600,
...
const FixingMessage = MuiStyled('div')((style: { theme: Theme }) => ({
  fontSize: 16,
    ...
    <Wrapper>
      <Container sx={{ display: 'flex' }}>
        <MainContent>
          <LeftBlock>
            <div>
              <TitleWrapper>{t('500.page_title')}</TitleWrapper>
              <MainMessage>{t('500.main_message')}</MainMessage>
              <FixingMessage>{t('500.fixing_message')}</FixingMessage>
            </div>
          ...
          <RightBlock>
            <Image src="/images/500-banner.svg" alt="AP9" layout="fill" />
          </RightBlock>
        </MainContent>
      </Container>
    </Wrapper>
